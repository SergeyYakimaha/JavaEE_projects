...
public class CarJDBCDao implements CarDAO {
    ...
    public void add(Car car) {
        ...
        try {
            ...
            if (markId == -1) {
                statement = connection.prepareStatement("INSERT INTO marks(mark) VALUES (?)", Statement.RETURN_GENERATED_KEYS);
...
//                markId = rs.getInt(1);
    ...
    private Connection getConnection() {
        ...
        try {
            connection = DriverManager.getConnection("jdbc:postgresql://localhost:5432/carsshop", "postgres", "admin");
            return connection;
        } catch(SQLException e) {
            e.printStackTrace();
        }
